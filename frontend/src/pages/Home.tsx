...
export default function Home() {
  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-7xl px-6 py-20 text-center">
        <p className="font-serif text-2xl text-royal-900">Loading collection...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="mx-auto max-w-7xl px-6 py-20 text-center">
        <p className="font-serif text-2xl text-royal-900">We couldn’t load the latest collection.</p>
